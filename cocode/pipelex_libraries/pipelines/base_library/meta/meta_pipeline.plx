domain = "meta"
description = "Meta domain is the domain of pipelines about pipelines"
...
description = "Details enabling to create a pipeline"
structure = "PipelexBundleBlueprint"

[pipe]
[pipe.build_blueprint]
type = "PipeSequence"
description = "Build a pipeline blueprint from natural language requirements"
...
type = "PipeLLM"
description = "Generate a rough pipeline draft from natural language requirements"
...
type = "PipeLLM"
description = "Generate a pipeline blueprint from natural language requirements"
